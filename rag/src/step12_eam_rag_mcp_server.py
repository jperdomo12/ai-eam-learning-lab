...
def get_embedding_model():
    """Carga MiniLM una sola vez desde caché local y lo reutiliza durante la sesión MCP."""
    ...
    if _embedding_model is None:
        ...
        # MCP por stdio reserva stdout para JSON-RPC. Además, este LAB ya verificó
        # que el modelo existe en caché local; evitamos consultas innecesarias a HF Hub.
...
if __name__ == "__main__":
    # El servidor publica las Tools inmediatamente. MiniLM se carga de forma perezosa
    # en la primera consulta RAG, pero solo desde la caché local ya verificada.
    mcp.run()
